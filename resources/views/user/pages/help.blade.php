			...
			<div class="row">
				<div class="col-lg-4">
					<aside>
						<ul>
							<li>
								<a href="help1.html" class="active"><i class="fas fa-chevron-right"></i>User Agreement</a>
							</li>
							<li>
								<a href="help2.html" ><i class="fas fa-chevron-right"></i>Privacy Policy</a>
							</li>
							<li>
					...
					<div class="help-content">
						...
						<div class="h-inner-content">
							...
							<ul>
								<li>
									<p>
										1. These User Agreement apply to the usage of games accessible through
Sorko
									</p>
								</li>
								<li>
